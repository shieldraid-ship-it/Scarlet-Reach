...
/mob/living/simple_animal/hostile/retaliate/rogue/elemental/attackby(obj/item/I, mob/living/carbon/human/user, params)
	if(istype(I, /obj/item/magic/))
		...
		if(istype(magicmaterial, /obj/item/magic/elementalmote) || istype(magicmaterial, /obj/item/magic/elementalfragment) || istype(magicmaterial, /obj/item/magic/elementalfragment) || istype(magicmaterial, /obj/item/magic/elementalrelic))
			if(health == maxHealth)
