...
/client/proc/show_influences()
	...
	data += god_ui_block("BAOTHA", "#4a0044", "#ffbbff", "\
		...
		Number of knottings: [GLOB.scarlet_round_stats[STATS_KNOTTED_NOT_LUPIANS]] ([get_colored_influence_value(SSgamemode.calculate_specific_influence(baotha_storyteller, STATS_KNOTTED_NOT_LUPIANS))])", baotha_storyteller)
