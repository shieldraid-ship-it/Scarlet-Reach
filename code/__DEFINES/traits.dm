...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_DUALWIELDER = span_info("If I wield two identical weapons, I roll twice for my attacks, and so will the enemy against me. On successful attacks, I shall strike again at 80% of my strength. I do not suffer penalties from using my off-hand in combat."),
