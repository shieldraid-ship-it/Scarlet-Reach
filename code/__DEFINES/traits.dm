...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_DUALWIELDER = span_info("If I wield two identical weapons, I roll twice for my attacks, and so will the enemy against me. On non-armor attacks that successfully hit, I roll a 50% chance to strike again at half strength. I do not suffer penalties from using my off-hand in combat."),
