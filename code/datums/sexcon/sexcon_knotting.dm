...
/datum/sex_controller/proc/knot_try()
	...
	if(target.stat != DEAD)
		switch(target.sexcon.knotted_part)
			...
			if(SEX_PART_CUNT|SEX_PART_JAWS)
				to_chat(target, span_userdanger("You have been double-knotted!"))
			if(SEX_PART_CUNT|SEX_PART_SLIT_SHEATH)
				to_chat(target, span_userdanger("You have been double-knotted!"))
			if(SEX_PART_ANUS|SEX_PART_SLIT_SHEATH)
				to_chat(target, span_userdanger("You have been double-knotted!"))
			if(SEX_PART_ANUS|SEX_PART_JAWS)
				to_chat(target, span_userdanger("You have been double-knotted!"))
			if(SEX_PART_JAWS|SEX_PART_SLIT_SHEATH)
				to_chat(target, span_userdanger("You have been double-knotted!"))
			else
